...
st.title("📊 Dashboard Interactivo de Temperaturas por Estación - Periodo 01-01-25 al 06-01-25")
st.subheader("Elaborado por Departamento de Confiabilidad de Cecuamaq, C.A.")
